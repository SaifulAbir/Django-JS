...
from exam_paper.models import Exampaper, AssignQuestionnaire
from pro.models import Professional
from question.models import Answer
from questionnaire.models import Questionnaire
from registration.models import Registration
import resources.strings_exam_paper as questionnaire_submit_strings
...
class QuestionnaireSubmitAdmin(ModelAdmin):
    ...
    def result_summary(self, request):
        ...
        for full_result in partial_result:
            ...
            full_result['exampaper_obj'] = Exampaper.objects.filter(registration_id=full_result['registration_id']).latest('created_date')
        ...
        context = dict(
            ...
            result = result_list,
            questionnaire_submit_strings = questionnaire_submit_strings
        )
    ...
    def assign_questionnaire_create(self, request):
        ...
        examinee_list = Professional.objects.all()
