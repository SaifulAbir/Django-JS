...
urlpatterns = [
    ...
    path('pro/education-object/<str:pk>/', EducationObject.as_view()),
    path('pro/recent-activity/', pro_recent_activity),
    path('pro/info-box/', info_box_api),
    path('pro/skill-object/<str:pk>/', SkillObject.as_view()),
    ...
    path('institute-search/', institute_search),
    path('certificate-name/', CertificateNameList.as_view()),
